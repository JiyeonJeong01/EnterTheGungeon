...
enum ManagerType { M_INPUT, M_OBJECT, M_SCENE, M_UI, M_BMP, M_CAMERA, M_MAP, M_INVEN, M_SOUND, M_STAGE, MGREND };
...
enum SceneType { SC_INTRO, SC_STAGE01, SC_STAGE02, SC_STORE, SC_TEST, SC_MAIN, SC_END};
